...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/recovery/root/system/etc/twrp.flags:root/system/etc/twrp.flags \
    $(DEVICE_PATH)/recovery/root/init.recovery.mt6765.rc:root/init.recovery.mt6765.rc \
    $(DEVICE_PATH)/recovery/root/system/etc/recovery.fstab:root/system/etc/recovery.fstab \
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/recovery/root/system/bin/service:root/system/bin/service \
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/recovery/root/vendor/lib64/libkmsetkey.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libkmsetkey.so \

...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/recovery/root/vendor/lib64/libmtee.so:$(TARGET_COPY_FILE_VENDOR)/lib64/libmtee.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/recovery/rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.recovery.mt6765.rc \
    $(DEVICE_PATH)/recovery/root/system/etc/init/init.recovery.microtrust.rc:$(TARGET_COPY_OUT_SYSTEM)/etc/init/init.recovery.microtrust.rc \
    $(DEVICE_PATH)/recovery/root/system/etc/init/init.recovery.usb.rc:$(TARGET_COPY_OUT_SYSTEM)/etc/init/init.recovery.usb.rc \
